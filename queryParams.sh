...
./a.out ../$1/edges.txt ../$1/labels.txt ../$1/attributes.txt ../$1/querymix.txt ../$1/querynw100.log 0 4 1 1.0 > ../$1/querynw100.csv
...
cd ../BBFS
./a.out $1qmix1 ../$1/edges.txt ../$1/labels.txt 1 ../$1/oldquerymix.txt > ../$1/querymixBBFS.csv
